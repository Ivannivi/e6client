...
export function UploadModal({ isOpen, onClose, settings }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
      <div
        className="bg-surface-container rounded-xl shadow-elevation-3 w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col"
      ...
      >
        ...
        {/* Content */}
        <form onSubmit={handleSubmit} className="p-6 space-y-6 flex-1 overflow-y-auto bg-surface-container">
          {/* File picker */}
          <div>
        ...
        <footer className="p-6 border-t border-outline-variant/40 flex justify-end bg-surface-container-low rounded-b-xl sticky bottom-0 z-10">
          ...
          <Ripple
            className="rounded-full bg-primary text-on-primary shadow-elevation-1 disabled:opacity-50"
